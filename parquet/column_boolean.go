...
func newBooleanColumnChunkReader(r io.ReadSeeker, col Column, chunk parquetformat.ColumnChunk) (*booleanColumnChunkReader, error) {
...
func (cr *booleanColumnChunkReader) D() int {
	return cr.curLevels.d
}

func (cr *booleanColumnChunkReader) R() int {
	return cr.curLevels.r
}
