...
type PageWriter struct {
	compressionCodec *parquetformat.CompressionCodec
}

func NewPageWriter(compressionCodec *parquetformat.CompressionCodec) *PageWriter {
	return nil
}
...
func TestEncodeDataPageHeader(t *testing.T) {
	...
	columnSchema.Type = parquetformat.Type_INT32
